...
// imgui addons
bool input_text_multiline_hint( const char* label, const char* hint, char* buf, size_t buf_size, const ImVec2& size = ImVec2( 0, 0 ), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL );
bool input_text_multiline_hint( const char* label, const char* hint, std::string* str, const ImVec2& size = ImVec2( 0, 0 ), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = nullptr, void* user_data = nullptr );
}
