...
struct MediaTool
{
    ...
    kl::Ref<SystemSection> system_section = new SystemSection( window, imgui_context );
    ...
    kl::Ref<ProcessSection> process_section = new ProcessSection( window, imgui_context );
