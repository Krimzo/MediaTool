...
void mt::SystemSection::display()
{
    ...
    if (im::BeginChild("System Log View", {-1.0f, 400.0f}, ImGuiChildFlags_Borders,
                       ImGuiWindowFlags_HorizontalScrollbar))
    {
        ...
        {
            im::TextColored({1.0f, 1.0f, 1.0f, 1.0f},
                            kl::format(std::setfill('0'), std::setw(3), log_index + 1, ".").c_str());
            im::SameLine();
